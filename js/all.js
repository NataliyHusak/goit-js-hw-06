...
// const getUsersWithGender = (users, gender) => users.reduce((allNames, gender) =>
//  {(if user.gender === gender), allNames.push(...user.name), return allNames }[]));
...
// добавити функцію на визначення довжини поля friends
